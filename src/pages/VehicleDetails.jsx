...
function VehicleDetails() {
  ...
  const handleSubmitReport = async () => {
    ...
    try {
      ...
      if (reportType === "Vehicle Stolen") {
        ...
        const activeStolenReport = existingReportsSnapshot.docs.find(
          (reportDoc) => {
            const existingReport = reportDoc.data();

            return (
              existingReport.reportType === "Vehicle Stolen" &&
        ...
        if (activeStolenReport) {
          const existingReport = activeStolenReport.data();

          if (existingReport.status === "Approved") {
            alert("🚨 This vehicle is already reported stolen.");
          } else {
            alert(
              "⏳ A stolen-vehicle report for this vehicle is already pending Admin review."
            );
          }
  ...
  const handleRemoveVehicle = async () => {
    const confirmed = window.confirm(t("removeVehicleConfirm"));
